...
<head>
	...
	<title>JobLand - Contact Us</title>
    ...
    <meta property="og:image:alt" content="JobLand" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Pristina, <br/>Kosovo</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:JobLand@business.com">JobLand@business.com</a>
								</li>
								<li>
