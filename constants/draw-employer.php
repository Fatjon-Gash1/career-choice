...
<h4 class="modal-title text-center">Create your company account</h4>
</div>
...
<input class="form-control" placeholder="Eg: Finance, IT, Computer Software etc" name="type" required type="text"> 
</div>
...
<input class="form-control" placeholder="Re-type password" name="confirmpassword" required type="password"> 
</div>
